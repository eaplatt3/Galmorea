...
public class GalmoreasLevel_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galmoreas_level_1_1);
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(GalmoreasLevel_1_1.this, GalmoreasLoginPage.class));
                    finish();
                }
            }
        };
    ...
    public void nextLevel(View view) {
        ...
        if(score == 20) {
            ...
            Intent intent = GalmoreasLevel_1_2.makeIntent(GalmoreasLevel_1_1.this, score);
    ...
    public void moveAnimationRight() {
        ...
        Animation img = new TranslateAnimation(Animation.ABSOLUTE, 420, Animation.ABSOLUTE, Animation.ABSOLUTE);
